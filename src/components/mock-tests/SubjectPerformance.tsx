        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-md sticky top-24">
            ...
            <div className="mt-8 pt-6 border-t border-slate-200">
                 ...
                 <ul className="space-y-3 text-sm text-slate-500">
                    <li className="flex items-start gap-3"><span className="text-green-500 mt-1">✓</span> <span><strong>Strong in Computer Concepts:</strong> Consistently scoring above 85%.</span></li>
                    <li className="flex items-start gap-3"><span className="text-yellow-500 mt-1">~</span> <span><strong>Focus on General Awareness:</strong> Room for improvement in current affairs.</span></li>
                    <li className="flex items-start gap-3"><span className="text-blue-500 mt-1">→</span> <span><strong>Practice more reasoning:</strong> Improve speed and accuracy.</span></li>
                 </ul>
            </div>
        </div>
    );
