...
// --- SVG ICONS ---
// I've removed the IconBookOpen since we are replacing it with an image.
...
const IconVideo = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m22 8-6 4 6 4V8Z"></path><rect width="14" height="12" x="2" y="6" rx="2" ry="2"></rect></svg>
);
...
const Navbar = () => {
    ...
    const navLinks = [
        { href: "/", label: "Home", icon: null, active: true },
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <Link href="/" className="flex items-center space-x-2">
                            ...
                            <Image 
                                src="/mcaverse-logo.png" // Assumes your logo is named this in the /public folder
                                alt="MCAverse Logo"
                                width={32} // Set the width of your logo
                                height={32} // Set the height of your logo
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                         <a href="#" className="bg-indigo-600 text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-indigo-700 transition-colors duration-200">
                            Share
                        </a>
                    </div>
                ...
                <div className="md:hidden">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        {navLinks.map((link) => (
                         ...
                         <a href="#" className="block w-full text-center bg-indigo-600 text-white mt-4 px-4 py-2 rounded-md text-sm font-semibold hover:bg-indigo-700 transition-colors duration-200">
                            Share
                        </a>
                    </div>
                </div>
