                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center justify-end space-x-4">
                        {isLoggedIn ? (
                            ...
                            <Link href="/login" className="bg-white text-slate-900 px-4 py-2 rounded-md text-sm font-semibold hover:bg-slate-200">Login</Link>
                        )}
                        <button onClick={handleShare} className="bg-indigo-600 text-white p-2 rounded-md text-sm font-semibold hover:bg-indigo-700 transition-colors duration-200">
                            <IconShare />
                        </button>
                    </div>
            ...
            {isMenuOpen && (
                <div className="md:hidden">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <div className="border-t border-slate-700 mt-4 pt-4 flex flex-col space-y-2">
                            {isLoggedIn ? (
                                <button onClick={() => setIsLoggedIn(false)} className="w-full text-left bg-slate-700 text-white px-3 py-2 rounded-md text-base font-medium">Logout</button>
                            ) : (
                                <Link href="/login" className="block bg-white text-slate-900 px-3 py-2 rounded-md text-base font-semibold text-center">Login</Link>
                            )}
                            <button onClick={handleShare} className="flex items-center justify-center gap-2 bg-indigo-600 text-white px-3 py-2 rounded-md text-base font-semibold">
                                <IconShare />
                                <span>Share</span>
                            </button>
                        </div>
