...
export const Hero = () => {
    ...
    return (
        <section id="home" className="relative text-white pt-32 pb-20 min-h-screen flex items-center justify-center bg-slate-900">
            ...
            <div className="relative z-10 container mx-auto px-4 text-center">
                ...
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-4">MCAverse</h1>
