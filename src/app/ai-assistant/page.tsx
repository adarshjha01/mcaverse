...
export default function AIAssistantPage() {
  return (
    <main className="pt-16">
      {/* Header */}
      <section className="py-20 text-center bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
        <div className="w-16 h-16 mx-auto bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-full flex items-center justify-center mb-4">
